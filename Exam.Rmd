...
cat("The test error obtained was: ", RMSE, "\n")
```
The test error obtained was `RMSE`

### 3.c
```{r RidgeModel on College}
library(glmnet)
library(ISLR)
...
cat("The test error with Ridge Regression was was:", RMSE, "with lambda =", bestlam,"\n")
```
The test error with Ridge Regression was was:`RMSE` with lambda = `bestlam`

### 3.d
```{r LassoModel on College}
library(glmnet)
library(ISLR)
...
cat("The test error with Ridge Regression was was:", RMSE, "with lambda =", bestlam,"\n")
```
The test error with Lasso model was was:`RMSE` with lambda = `bestlam`

### 3.e

### 3.f
```{r PLS_model on College}
library(pls)
library(ISLR)
